...
describe('Redux schema tests', () => {
  // Tests for schema/notifications.js

  it('Verifies that getAllNotificationsByUser returns correct data', () => {
  ...
  it('Verifies that normalized data has correct users entity for given user id', () => {
  ...
  it('Verifies that normalized data has correct notifications entity for given id', () => {
