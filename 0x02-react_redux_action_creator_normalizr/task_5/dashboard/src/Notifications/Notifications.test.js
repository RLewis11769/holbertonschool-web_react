...
describe('Notifications component', () => {
  ...
  // handleDisplayDrawer test
  it('Verifies that Notifications calls handleDisplayDrawer when clicked', () => {
  ...
  // handleHideDrawer test
  it('Verifies that Notifications calls handleHideDrawer when clicked', () => {
